...
$('document').ready(function () {
	...
	$('#preloader #OpenDoor').click(function () {
		$('#leftdoor').css({ 'transform': 'translateX(-50vw)', 'background': 'rgba(0,0,0,0)' });
		$('#rightdoor').css({ 'transform': 'translateX(50vw)', 'background': 'rgba(0,0,0,0)' });
		$(this).fadeOut('fast');
	...
	$('#turn_on').click(function () {
		...
		$('body').addClass('peach');
		$("#devloper").css({ 'color': "rgba(3, 45, 45, 0.559)" });
